            ...
            >
                    ...
                    {currentStep === 3 && (
                        <div className="form-step step-3">
                            <div className="success-animation">
                                ...
                                <p>Recebemos sua mensagem e entraremos em contato em breve. Obrigado pelo interesse
                                    na {companyName}!</p>
                ...
                <div className="popup-footer">
                    <div className="security-badge">
                        <svg viewBox="0 0 24 24" fill="none">
                            <path d="M12 22S8 18 8 13V7L12 5L16 7V13C16 18 12 22 12 22Z" stroke="currentColor"
